        ...
        <div className="bg-white rounded-[20px] p-6 shadow-sm border border-gray-100 relative overflow-hidden group hover:shadow-md transition-shadow">
          <div className="relative z-10">
            ...
            <div className="flex items-end gap-2 mb-1">
              ...
              <span className="bg-emerald-50 text-emerald-600 text-xs font-bold px-2 py-1 rounded-full mb-1">
                +5%
              </span>
            </div>
          </div>
        ...
        <div className="bg-white rounded-[20px] p-6 shadow-sm border border-gray-100 relative overflow-hidden hover:shadow-md transition-shadow">
          <div className="relative z-10">
            ...
            <div className="flex items-end gap-2 mb-1">
              ...
              <span className="bg-orange-50 text-orange-600 text-xs font-bold px-2 py-1 rounded-full mb-1">
                Action Needed
              </span>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-[20px] p-6 shadow-sm border border-gray-100 flex flex-col">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link
              to="/invoices"
              className="text-sm text-[#2C9DA6] font-medium hover:underline"
            >
              View All
            </Link>
          </div>
          ...
          <div className="flex-1 overflow-y-auto pr-2 space-y-4">
            {recentSales.length > 0 ? (
              recentSales.map((sale) => (
                <div
                  key={sale.id}
                  className="group flex items-center justify-between p-3 rounded-2xl hover:bg-[#F7F9FB] transition-colors border border-transparent hover:border-gray-100"
                >
