    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-800 relative">
      ...
      <nav className="relative max-w-7xl mx-auto px-6 py-6 flex items-center justify-between z-10">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-medium text-gray-600">
          <a href="#" className="hover:text-[#238898] transition">
            Features
          </a>
          <a href="#" className="hover:text-[#238898] transition">
            Pricing
          </a>
          <Link to="/login" className="hover:text-[#238898] transition">
            Login
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 max-w-lg">
            ...
            <h1 className="text-5xl md:text-6xl font-extrabold text-slate-900 leading-[1.1]">
              Manage Your Shop <br />
              <span className="text-[#238898] underline decoration-[#238898]/20 decoration-4 underline-offset-4">
                with Ease
              </span>
            </h1>
            ...
            <p className="text-lg text-gray-500 leading-relaxed">
              ...
              Track stock, bill customers, and grow your sales without the
              headache.
            </p>
            ...
            <div className="mt-6 flex items-center gap-4 px-2">
              <div className="flex -space-x-3">
                {[1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="w-9 h-9 rounded-full border-2 border-[#F7F9FB] bg-gray-300 overflow-hidden"
                  >
                    <img
                ...
                <div className="p-6 grid grid-cols-12 gap-4 opacity-90">
                  ...
                  <div className="col-span-9 space-y-4">
                    ...
                    <div className="h-32 bg-slate-800 rounded-xl border border-slate-700/50 relative overflow-hidden">
                      ...
                      <svg
                        className="absolute bottom-0 left-0 right-0 h-16 text-[#238898]"
                        preserveAspectRatio="none"
                        viewBox="0 0 100 100"
                      >
                        <path
                          d="M0 100 L 0 60 Q 25 40 50 60 T 100 30 V 100 Z"
                          fill="currentColor"
                          opacity="0.4"
                        />
                        <path
                          d="M0 100 L 0 80 Q 25 60 50 80 T 100 50 V 100 Z"
                          fill="currentColor"
                          opacity="0.6"
                        />
                      </svg>
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 py-20">
        <div className="max-w-2xl mb-16">
          <h2 className="text-3xl font-bold text-slate-900 mb-4">
            Everything you need to <br /> run your shop
          </h2>
          <p className="text-gray-500">
            Powerful features packaged in a simple interface. We removed the
            clutter so you can focus on selling.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white border border-gray-100 p-8 rounded-2xl shadow-xl shadow-gray-200/40 hover:-translate-y-1 transition duration-300">
            ...
            <p className="text-gray-500 text-sm leading-relaxed">
              Keep real-time tabs on your stock levels. Get low-stock alerts
              automatically.
            </p>
          </div>
          ...
          <div className="bg-white border border-gray-100 p-8 rounded-2xl shadow-xl shadow-gray-200/40 hover:-translate-y-1 transition duration-300">
            ...
            <p className="text-gray-500 text-sm leading-relaxed">
              Generate professional invoices in seconds. Scan barcodes and add
              discounts easily.
            </p>
          </div>
          ...
          <div className="bg-white border border-gray-100 p-8 rounded-2xl shadow-xl shadow-gray-200/40 hover:-translate-y-1 transition duration-300">
            ...
            <p className="text-gray-500 text-sm leading-relaxed">
              Visualize profit margins, peak hours, and top products with simple
              dashboards.
            </p>
          </div>
        </div>
        ...
        <div className="bg-[#1e293b] rounded-3xl p-12 md:p-16 text-center relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10 max-w-2xl mx-auto space-y-6">
            ...
            <p className="text-gray-300 text-lg">
              Join thousands of shop owners using Mini ERP today. Start your
              14-day free trial.
            </p>
