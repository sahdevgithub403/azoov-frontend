    ...
    <div className="space-y-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-2 text-sm max-w-2xl">
          Manage your shop's public identity, logo, and contact details visible
          to your customers.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="w-full lg:w-85 shrink-0 space-y-6">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <button
              type="button"
              className="w-full mt-4 flex items-center justify-center gap-2 text-red-500 hover:text-red-600 text-sm font-medium py-2 hover:bg-red-50 rounded-lg transition-colors"
            >
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600 leading-relaxed">
                  Your business logo appears on all printed invoices and
                  customer email notifications. Make sure it's high resolution!
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
            <div className="flex items-center justify-between mb-6">
              ...
              <div
                ...
                title="These details will be publicly visible"
              >
                <Icons.Info />
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-1.5">
                    <label className="block text-xs font-bold text-gray-400 ml-1 uppercase tracking-wide">
                      Currency
                    </label>
                    <div className="relative">
                      <select
      ...
      {message && (
        <div
          className={`fixed bottom-6 right-6 px-6 py-3 rounded-xl shadow-2xl transform transition-all duration-300 z-50 flex items-center gap-3 ${message.includes("success") ? "bg-gray-900 text-white" : "bg-red-500 text-white"}`}
        >
